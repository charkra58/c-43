class Game {
        ...
        displayRanks(){
          ...
          if(allPlayers[plr].place===1){
            ...
            text("sencond: "+allPlayers[plr].name,displayWidth/4,displayHeight/9+73)
          }else  if(allPlayers[plr].place===3){
            text("sthird: "+allPlayers[plr].name,displayWidth/-4,displayHeight/10+76)
          }else {
